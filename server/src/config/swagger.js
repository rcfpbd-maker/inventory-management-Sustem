      ...
      schemas: {
        ...
        Order: {
          ...
          properties: {
            ...
            platform: { type: "string", example: "Direct" },
            status: {
              type: "string",
              enum: ['PENDING', 'CONFIRMED', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'RETURNED']
            },
            deliveryType: { type: "string", example: "Standard" },
            paymentStatus: {
              type: "string",
              enum: ['UNPAID', 'PARTIAL', 'PAID', 'DUE']
            },
        ...
        Payment: {
          ...
          properties: {
            ...
            paymentMethod: {
              type: "string",
              enum: ['CASH', 'BKASH', 'NAGAD', 'ROCKET', 'CARD', 'BANK_TRANSFER']
            },
        ...
        OrderReturn: {
          ...
          properties: {
            id: { type: "string" },
            orderId: { type: "string" },
            type: { type: "string", enum: ['RETURN', 'REFUND'] },
            amount: { type: "number" },
            reason: { type: "string" },
            date: { type: "string", format: "date-time" },
          },
